...
(function($opal) {
  ...
  $opal.add_stubs(['$require', '$new', '$attr_accessor', '$image', '$display', '$[]', '$-', '$attr_reader', '$pressing?', '$keyboard', '$<', '$+', '$>', '$%', '$image_cropped', '$*', '$floor', '$/', '$class', '$rand', '$width', '$height', '$x', '$y', '$sqrt', '$**', '$size=', '$reset_game', '$length', '$push', '$pressed?', '$!', '$each', '$act', '$is_a?', '$==', '$hit?', '$alive=', '$play', '$hit_sound', '$===', '$max', '$delete_if', '$alive', '$clear', '$fill_color=', '$fill_rectangle', '$size', '$render', '$text_size=', '$fill_text']);
  self.$require("math");
  return (function($base, $super) {
    ...
    $opal.cdecl($scope, 'Context', $scope.get('Struct').$new("display", "keyboard"));
    ...
    (function($base, $super) {
      ...
      return (def.$render = function(c) {
        ...
        return c.$display().$image(self.image, $scope.get('V')['$[]'](self.x, self.y));
      }, nil) && 'render';
    })(self, null);
    ...
    (function($base, $super) {
      ...
      def.$initialize = TMP_1 = function(c) {var $zuper = $slice.call(arguments, 0);
        ...
        self.image = $scope.get('Image')['$[]']("images/noschar.png");
        self.x = 240;
        self.y = (400)['$-'](32);
        return self.anim = 0;
      };
      ...
      return (def.$render = function(c) {
        ...
        return c.$display().$image_cropped(self.image, $scope.get('V')['$[]'](self.x, self.y), $scope.get('V')['$[]']((self.anim['$/'](10)).$floor()['$*'](32), 0), $scope.get('V')['$[]'](32, 32));
      }, nil) && 'render';
    ...
    (function($base, $super) {
      ...
      $opal.defs(self, '$image', function() {
        ...
        return ((($a = self.image) !== false && $a !== nil) ? $a : self.image = $scope.get('Image')['$[]']("images/apple.png"));
      });
      ...
      $opal.defs(self, '$hit_sound', function() {
        ...
        return ((($a = self.sound) !== false && $a !== nil) ? $a : self.sound = $scope.get('Sound')['$[]']("sounds/get.wav"));
      });

      return (def['$hit?'] = function(player) {
        var self = this, xdiff = nil, ydiff = nil, distance = nil;

        xdiff = (self.x['$+'](38))['$-']((player.$x()['$+'](16)));
        ydiff = (self.y['$+'](48))['$-']((player.$y()['$+'](16)));
        distance = $scope.get('Math').$sqrt(xdiff['$**'](2)['$+'](ydiff['$**'](2)));
    ...
    (function($base, $super) {
      ...
      $opal.defs(self, '$image', function() {
        ...
        return ((($a = self.image) !== false && $a !== nil) ? $a : self.image = $scope.get('Image')['$[]']("images/bomb.png"));
      });
      ...
      $opal.defs(self, '$hit_sound', function() {
        ...
        return ((($a = self.sound) !== false && $a !== nil) ? $a : self.sound = $scope.get('Sound')['$[]']("sounds/bom08.wav"));
      });
    ...
    def.$setup = function() {
      ...
      self.context = $scope.get('Context').$new(self.$display(), self.$keyboard());
      self.$display()['$size=']($scope.get('V')['$[]'](640, 480));
      self.high_score = 0;
    ...
    def.$reset_game = function() {
      ...
      self.player = $scope.get('Player').$new(self.context);
    ...
    return (def.$update = function(elapsed) {
      ...
      item = (function() {if ((($b = (self.$rand(100)['$<'](80))) !== nil && (!$b._isBoolean || $b == true))) {
        return $scope.get('Bomb').$new(self.context)
        } else {
        return $scope.get('Apple').$new(self.context)
      }; return nil; })();
      ...
      ($a = ($b = self.actors).$each, $a._p = (TMP_3 = function(x){var self = TMP_3._s || this, $a, $b, $case = nil;
...
if (x == null) x = nil;
      x.$act(self.context);
        if ((($a = ($b = x['$is_a?']($scope.get('Item')), $b !== false && $b !== nil ?self.state['$==']("playing") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          if ((($a = x['$hit?'](self.player)) !== nil && (!$a._isBoolean || $a == true))) {
            x['$alive='](false);
            if ((($a = self.play_sound) !== nil && (!$a._isBoolean || $a == true))) {
              x.$class().$hit_sound().$play()};
            return (function() {$case = x;if ($scope.get('Apple')['$===']($case)) {return self.score = self.score['$+'](1)}else if ($scope.get('Bomb')['$===']($case)) {self.state = "gameover";
...
if (x == null) x = nil;
      ...
      self.$display().$clear();
      self.$display()['$fill_color=']($scope.get('C')['$[]'](128, 255, 255));
      self.$display().$fill_rectangle($scope.get('V')['$[]'](0, 0), self.$display().$size());
      self.$display()['$fill_color=']($scope.get('C')['$[]'](0, 128, 0));
      self.$display().$fill_rectangle($scope.get('V')['$[]'](0, 400), $scope.get('V')['$[]'](640, 180));
...
if (x == null) x = nil;
      ...
      self.$display()['$fill_color=']($scope.get('C')['$[]'](0, 0, 0));
      self.$display()['$text_size='](24);
      self.$display().$fill_text("SCORE: " + (self.score) + "  HIGHSCORE: " + (self.high_score), $scope.get('V')['$[]'](0, 30));
      if (self.state['$==']("gameover")) {
        self.$display().$fill_text("GAME OVER (PRESS ENTER)", $scope.get('V')['$[]'](0, 120))};
      self.$display()['$text_size='](12);
      self.$display()['$fill_color=']($scope.get('C')['$[]'](255, 255, 255));
      return self.$display().$fill_text("[S] sound(" + (self.play_sound) + ")", $scope.get('V')['$[]'](0, 480));
    }, nil) && 'update';
  })(self, $scope.get('Game'));
})(Opal);
